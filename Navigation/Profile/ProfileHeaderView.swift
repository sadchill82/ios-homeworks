...
final class ProfileHeaderView: UITableViewHeaderFooterView {
    ...
    private var statusText = NSLocalizedString("ready_to_help", comment: "Status text")
    ...
    private func setupNameLabel() {
        ...
        fullNameLabel.text = NSLocalizedString("teo_west", comment: "Full name")
    ...
    private func setupStatusTextField() {
        ...
        statusTextField.attributedPlaceholder = NSAttributedString.init(string: NSLocalizedString("ready", comment: "Status placeholder"), attributes: [NSAttributedString.Key.foregroundColor: UIColor.darkGray])
    ...
    private func setupStatusButton() {
        ...
        setStatusButton.setTitle(NSLocalizedString("show_status", comment: "Show status button title"), for: .normal)
